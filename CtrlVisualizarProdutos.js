...
module.exports = {
  configurar: async (srv) => {
    ...
    servidor.get("/produtos", module.exports.visualizarProdutos);
  },

  visualizarProdutos: async (request, reply) => {
    ...
    // Se a requisição veio com o parâmetro 'raw', devolvo o JSON com o conteúdo dos produtos.
